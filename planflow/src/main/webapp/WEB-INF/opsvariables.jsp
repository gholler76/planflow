...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	    <div class="navbar-nav">
	      ...
	      <a class="nav-link active" href="/opsvariables">Ops Variables<span class="sr-only">(current)</span></a>
    		...
    		<div class="col-6">
    			<div class="card" style="width: 18rem;">
  					<div class="card-body">
					    ...
					    <p class="card-text">Unload units per hour</p>
					    <p class="card-text">Load units per hour</p>
					    <p class="card-text">Pick units per hour</p>
					    <p class="card-text">Pick units per hour</p>
					    <p class="card-text">Pick units per hour</p>
					    <p class="card-text">Velocity classes</p>
				  	</div>
				</div>
   	 		</div>
    	</div>
