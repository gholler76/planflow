...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	    <div class="navbar-nav">
	      ...
	      <a class="nav-link active" href="/planningtools">Planning Tools<span class="sr-only">(current)</span></a>
    		...
    		<div class="col-6">
    			<div class="card" style="width: 18rem;">
  					<div class="card-body">
					    ...
					    <p class="card-text">Inbound shipments</p>
					    <p class="card-text">Outbound order planning</p>
					    <p class="card-text">Outbound</p>
					    <p class="card-text">Daily manpower</p>
				  	</div>
				</div>
   	 		</div>
    	</div>
